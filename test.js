  ...
  data.forEach(element => {
    ...
    if (i % 2 == 0){
      temp = new SupermarketM({
        type:element.type,
        properties: {id:element.id,name:element.properties.name,offers: [{id: "1",product: "Μπάμιες",price: "1000",date: "0/0/0000",likes: "-100",dislikes: "0",available: true}]},
      ...
      temp = new SupermarketM({
        type:element.type,
        properties: {id:element.id,name:element.properties.name,offers: []},
        geometry: {type:element.geometry.type, coordinates:element.geometry.coordinates}
      });
    }
